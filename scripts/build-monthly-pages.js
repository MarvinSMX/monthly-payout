#!/usr/bin/env node
/**
 * MonthlyPayout.com — Programmatic Page Builder
 * ------------------------------------------------------------------
...
const GA4 = 'G-REPLACE_ME';
const ADSENSE = 'ca-pub-REPLACE_ME';
...
<footer class="footer">
  ...
  <p style="font-size:.85em;color:#777;margin-top:12px">© ${new Date().getFullYear()} MonthlyPayout.com. For entertainment purposes only. Not financial advice.</p>
</footer>`;
...
<meta property="og:site_name" content="MonthlyPayout.com">
...
function buildTickerPage(f, all, idx) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `Yes. $${t} appears in the MonthlyPayout.com database of monthly-paying funds, meaning it distributes income on a monthly rather than quarterly schedule. Exact payment amounts and ex-dividend dates are set by the fund issuer and vary period to period.`
    },
    {
  ...
  const jsonLd = `<script type="application/ld+json">
{
 ...
 "@graph":[
  {"@type":"BreadcrumbList","itemListElement":[
    {"@type":"ListItem","position":1,"name":"MonthlyPayout.com","item":"${SITE}/"},
  ...
  {"@type":"WebPage","name":"${jsonEsc(t)} Monthly Dividend: Yield, Income Calculator & Price Decay",
   ...
   "publisher":{"@type":"Organization","name":"MonthlyPayout.com","url":"${SITE}/"}},
...
<p class="byline">Data updated ${TODAY_LONG} · MonthlyPayout.com</p>
